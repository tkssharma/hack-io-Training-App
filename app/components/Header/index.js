          ...
          <div className="navbar-holder">
            <div className="navbar-header">
              ...
              <a className="navbar-brand" href="https://next.io">
                <img
                  class="hackr-logo-text-path hidden-xs"
                      ...
                      <a href="https://next.io/tarun-sharma" className="notif-message-link">
                        ...
                        <div className="element notif-message-details">
                          <div className="message">
                            Welcome, Tarun. You've earned 10 reputation points for joining the next.io
                            community. Click here to have a look at your profile.
                          </div>
            ...
            <div className="nav-dropdown-sec nav-profile-sec">
              <div className="dropdown">
                <div id="profileDropdown" className="nav-dropdown nav-profile-dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li>
                      <a href="https://next.io/tarun-sharma?tab=saved">Saved Tutorials</a>
                    </li>
                    <li>
                      <a href="https://next.io/tarun-sharma">My Profile</a>
                    </li>
                    <li>
                      <a href="https://next.io/users/settings">Settings</a>
                    </li>
                    <li>
                      <a href="https://next.io/users/edit_password">Change Password</a>
                    </li>
                    <li>
                      <a href="https://next.io/users/logout" className="logout">Logout</a>
                    </li>
                  </ul>
                  <a href="https://next.io/notifications" className="txt profile-text">
                    ...
                    <ul className="badge-all">
                      <li className="main-badge gold" title="0 gold badge">
                        <i className="ion-record"></i>
                        <span className="txt">0</span>
                      </li>
                      <li className="main-badge silver" title="0 silver badge">
                        <i className="ion-record"></i>
                        <span className="txt">0</span>
                      </li>
                      <li className="main-badge bronze" title="0 bronze badge">
                        <i className="ion-record"></i>
                        <span className="txt">0</span>
                      </li>
                    </ul>
